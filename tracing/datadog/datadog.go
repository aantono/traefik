...
type Config struct {
	...
	TraceIDHeaderName          string `description:"Specifies the map key that will be used to store the trace ID.." export:"true"`
	ParentIDHeaderName         string `description:"Specifies the map key that will be used to store the parent ID." export:"true"`
	SamplingPriorityHeaderName string `description:"Specifies the map key that will be used to store the sampling priority." export:"true"`
	BagagePrefixHeaderName     string `description:"specifies the prefix that will be used to store baggage items in a map." export:"true"`
}
